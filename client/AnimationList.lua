...
RP.Shared = {
    ...
    ["bunnyneu100"] = {
        "mrwitt@merging_hearts_in_bed_m",
        "mrwitt",
        "Couple Bunny M",
        "bunnyneu200",
        AnimationOptions = {
    ...
    ["bunnyneu200"] = {
        "mrwitt@merging_hearts_in_bed_f",
        "mrwitt",
        "Couple Bunny F",
        "bunnyneu100",
        AnimationOptions = {
    ...
    ["pbauth1"] = {
        "pandora@authenticv1@bachata1",
        "pandora_fem",
        "[PB] AuthenticV1 - Bachata1F",
        "pbauth2",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["pbauth3"] = {
        "pandora@authenticv1@bachata2",
        "pandora_fem",
        "[PB] AuthenticV1 - Bachata2F",
        "pbauth4",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["pbauth5"] = {
        "pandora@authenticv1@bachata3",
        "pandora_fem",
        "[PB] AuthenticV1 - Bachata3F",
        "pbauth6",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["pbauth7"] = {
        "pandora@authenticv1@bachata4",
        "pandora_fem",
        "[PB] AuthenticV1 - Bachata4F",
        "pbauth8",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["pbauth9"] = {
        "pandora@authenticv1@salsa1",
        "pandora_fem",
        "[PB] AuthenticV1 - Salsa1F",
        "pbauth10",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["pbauth11"] = {
        "pandora@authenticv1@salsa2",
        "pandora_fem",
        "[PB] AuthenticV1 - Salsa2F",
        "pbauth12",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["pbauth13"] = {
        "pandora@authenticv1@salsa3",
        "pandora_fem",
        "[PB] AuthenticV1 - Salsa3F",
        "pbauth14",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["pbauth15"] = {
        "pandora@authenticv1@kompa1",
        "pandora_fem",
        "[PB] AuthenticV1 - Kompa1F",
        "pbauth16",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
...
RP.White2do = {
    ...
    ["zdancepartyf"] = {
        ...
        "Dance Party Female  Gangbanger v3",
        AnimationOptions =
        {
            EmoteMoving = false,
            EmoteLoop = true,
    ...
    ["zdancepartyf2"] = {
        "anim@amb@nightclub@dancers@crowddance_groups@",
        "hi_dance_crowd_09_v1_female^6",
        "Dance Party Female 2  Gangbanger v3",
        AnimationOptions =
        {
            EmoteMoving = false,
            EmoteLoop = true,
...
RP.White5to = {
    ...
    ["queensisters69"] = { -- Custom Emote By QueenSistersAnimations
        "collaboerationblackqueenanim@queensisters",
        "collaboerationblackqueenanim_clip",
        "QueenSister",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false
    ...
    ["snowmann3"] = { -- Custom Emote By QueenSistersAnimations
        "snowman@blackqueen",
        "snowman_clip",
        "Snowmann 69",
        AnimationOptions = {
    ...
    ["bunnypose"] = { -- Custom Emote By QueenSistersAnimations
        "janeanimations@modelpose2",
        "modelpose2_clip",
        "Bunny 69",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose2"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@floor_crossing_f",
        "mrwitt",
        "Bunny 70",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose3"] = { -- Custom Emote By QueenSistersAnimations
    ...
    ["bunnypose4"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@black_dressed_photo_shoot_f",
        "mrwitt",
        "Bunny 72",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose5"] = { -- Custom Emote By QueenSistersAnimations
    ...
    ["bunnypose6"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@bike_partner_tour_f",
        "mrwitt",
        "Bunny 74",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose7"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@bike_partner_tour_f_1",
        "mrwitt",
        "Bunny 75",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose8"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@nsfw_76_female",
        "mrwitt",
        "Bunny 76",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose9"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@nsfw_50_female",
        "mrwitt",
        "Bunny 77",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose10"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@nsfw_32_female",
        "mrwitt",
        "Bunny 78",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose11"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@nsfw_16",
        "mrwitt",
        "Bunny 79",
        AnimationOptions = {
    ...
    ["bunnypose12"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@nsfw_10",
        "mrwitt",
        "Bunny 80",
        AnimationOptions = {
    ...
    ["bunnypose13"] = { -- Custom Emote By QueenSistersAnimations
        "mrwitt@nsfw_09",
        "mrwitt",
        "Bunny 81",
        AnimationOptions = {
    ...
    ["bunnypose14"] = { -- Custom Emote By QueenSistersAnimations
        "sitnplay@lanisha2",
        "mrwitt_lanisha",
        "Bunny 82",
        AnimationOptions = {
    ...
    ["bunnypose15"] = { -- Custom Emote By QueenSistersAnimations
        "sitting@pose",
        "sitting_clip",
        "Bunny 83",
        AnimationOptions = {
    ...
    ["bunnypose16"] = { -- Custom Emote By QueenSistersAnimations
        "layingonground@animation",
        "layingonground_clip",
        "Bunny 84",
        AnimationOptions = {
            EmoteLoop = true,
    ...
    ["bunnypose17"] = { -- Custom Emote By QueenSistersAnimations
        "cutepose4@seimen",
        "cutepose4_clip",
        "Bunny 85",
        AnimationOptions = {
    ...
    ["bunnyposenew49"] = {
        "mrwitt@intimate_closeup_f",
        "mrwitt",
        "Bunny Female Closeup",
        AnimationOptions =
        {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["bunnyposenew52"] = {
        "mrwitt@loving_woman_with_red_roses",
        "mrwitt",
        "Bunny Update 1",
        AnimationOptions =
        {
    ...
    ["bunnyposenew54"] = {
        "mrwitt@seductive_bathtub_pose_f",
        "mrwitt",
        "Bunny Update 3",
        AnimationOptions =
        {
    ...
    ["bunnyposenew55"] = {
        "mrwitt@jeans_jacket_wall_support_m",
        "mrwitt",
        "Bun Männer 1",
        AnimationOptions =
        {
    ...
    ["defibrillator"] = {
        "defibrillator@animation",
        "defib_clip",
        "Defibrillator",
        AnimationOptions =
        {
            Prop = "alcaprop_medic_defibrillator",
            PropBone = 18905,
            PropPlacement = { 0.18, 0.01, 0.02, 110.0, -24.0, 166.0 },
            SecondProp = "alcaprop_medic_defibrillator",
            SecondPropBone = 57005,
            SecondPropPlacement = { 0.18, 0.01, -0.02, 73.0, -2.0, 165.0 },
    ...
    ["thermo"] = {
        "take@temperature@anim",
        "thermo_clip",
        "Take temperature",
        AnimationOptions =
        {
            Prop = "alcaprop_medic_thermo",
            PropBone = 57005,
            PropPlacement = { 0.13, 0.04, -0.01, 103.0, -97.0, 166.0 },
            --
            EmoteLoop = true,
            EmoteMoving = true,
        }
    ...
    ["syringe"] = {
        "disinfect@sting@anim",
        "sting_clip",
        "Injection",
        AnimationOptions =
        {
            Prop = "alcaprop_medic_gauze",
            PropBone = 18905,
            PropPlacement = { 0.16, 0.02, 0.03, 0.0, 0.0, 0.0 },
            SecondProp = "alcaprop_medic_syringe",
            SecondPropBone = 57005,
            SecondPropPlacement = { 0.17, 0.02, 0.02, 195.0, 27.0, 11.0 },
            --
            EmoteLoop = false,
            EmoteMoving = true,
        }
    ...
    -- For tablets, I recommand not to use dpemotes but to add each tablets and pills in your own script (request animation, create object etc)
    ["eat_pills"] = {
        "eat@pills@anim",
        "eat_pills_clip",
        "Take pills",
        AnimationOptions =
        {
            Prop = "alcaprop_medic_tylenal",
            PropBone = 18905,
            PropPlacement = { 0.16, 0.04, 0.02, -8.0, 168.0, 186.0 },
            --
            EmoteLoop = false,
            EmoteMoving = true,
        }
    ...
    ["surgery"] = {
        "surgery@scalpel@anim",
        "scalpel_clip",
        "Surgery",
        AnimationOptions =
        {
            Prop = "alcaprop_medic_scalpel",
            PropBone = 57005,
            PropPlacement = { 0.13, 0.06, -0.02, -2.0, -24.0, 180.0 },
            --
            EmoteLoop = true,
            EmoteMoving = true,
        }
    ...
    ["radio_look"] = {
        "radiography@animation",
        "radio_clip",
        "Look radiography",
        AnimationOptions =
        {
            Prop = "alcaprop_medic_radiography",
            PropBone = 18905,
            PropPlacement = { 0.44, 0.14, 0.06, 240.0, -60.0, 42.0 },
            --
            EmoteLoop = true,
            EmoteMoving = true,
        }
    ...
    ["bandage1"] = {
        "bandage@animation@arm",
        "bandage_arm_clip",
        "Bandage1",
        AnimationOptions =
        {
            Prop = "alcaprop_medic_bandage",
            PropBone = 18905,
            PropPlacement = { 0.14, 0.02, 0.02, 98.0, -104.0, -158.0 },
            --
            EmoteLoop = true,
            EmoteMoving = true,
        }
