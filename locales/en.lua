return {
    ...
    ['keybind_description'] =
    "This menu is to help you visualize the emotes that you have connected to a keybind, and the control that is used. \n\nYou can modify the key bindings in the GTA settings.",
